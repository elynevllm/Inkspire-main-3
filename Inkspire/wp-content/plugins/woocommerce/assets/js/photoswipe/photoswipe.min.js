  ...
  return function (p, n, e, t) {
    ...
    var r,
      ...
      Oe = function (e, t, n, i, o) {
        (!Ie || (o && o !== f.currItem)) && (i /= (o || f.currItem).fitRatio),
          (e[E] = v + t + "px, " + n + "px" + w + " scale(" + i + ")");
      },
      ke = function (e) {
        ne &&
          (e &&
            (x > f.currItem.fitRatio
              ? Ie || (an(f.currItem, !1, !0), (Ie = !0))
              : Ie && (an(f.currItem), (Ie = !1))),
          Oe(ne, me.x, me.y, x));
      },
      Re = function (e) {
        e.container &&
      ...
      Ze = function (e, t) {
        ...
        !h.loop &&
          ...
          (t = Math.round(e - mt.x)),
          ((n < 0 && 0 < t) || (n >= Vt() - 1 && t < 0)) &&
            (e = mt.x + t * h.mainScrollEndFriction)),
          (mt.x = e),
          Pe(e, l);
      },
      Fe = function (e, t) {
      ...
      Ne = function () {
        _e &&
          (m.unbind(document, "mousemove", Ne),
      ...
      t = {
          ...
          if (!r && !i) {
                ...
                (E = "left"),
                  ...
                  (ke = function () {
                    ...
                    ne &&
                      ((e = ne),
                      (n =
                        (t = 1 < (i = f.currItem).fitRatio ? 1 : i.fitRatio) *
                        i.w),
                      (i = t * i.h),
                      (e.width = n + "px"),
                      (e.height = i + "px"),
            ...
            for (
              (_.animationName && _.transform && !t) ||
                (h.showAnimationDuration = h.hideAnimationDuration = 0),
                e = 0;
              e < we.length;
              e++
            )
            ...
            n && (f.ui = new n(f, m)).init(),
              Se("firstUpdate"),
              (y = y || h.index || 0),
              (isNaN(y) || y < 0 || y >= Vt()) && (y = 0),
              (f.currItem = Xt(y)),
              (_.isOldIOSPhone || _.isOldAndroid) && (ve = !1),
              ...
              z === undefined &&
                (Se("initialLayout"), (z = F = m.getScrollY()));
            t = "pswp--open ";
            for (
              h.mainClass && (t += h.mainClass + " "),
                h.showHideOpacity && (t += "pswp--animate_opacity "),
                t += k ? "pswp--touch" : "pswp--notouch",
                t += _.animationName ? " pswp--css_animation" : "",
                t += _.svg ? " pswp--svg" : "",
                m.addClass(p, t),
                f.updateSize(),
                s = -1,
              ...
              Pe((e + s) * xe.x, C[e].el.style);
            L || m.bind(f.scrollWrap, c, f),
              Me("initialZoomInEnd", function () {
                f.setContent(C[0], y - 1),
                  f.setContent(C[2], y + 1),
                  (C[0].el.style.display = C[2].el.style.display = "block"),
                  h.focus && p.focus(),
                  m.bind(document, "keydown", f),
                  _.transform && m.bind(f.scrollWrap, "click", f),
                  h.mouseUsed || m.bind(document, "mousemove", Ne),
        ...
        close: function () {
          r &&
            ...
            m.unbind(document, "mousemove", Ne),
            _.transform && m.unbind(f.scrollWrap, "click", f),
            X && m.unbind(window, u, f),
            clearTimeout(N),
            Se("unbindEvents"),
            Kt(f.currItem, null, !0, f.destroy));
        },
        destroy: function () {
          Se("destroy"),
            Yt && clearTimeout(Yt),
        ...
        updateCurrZoomItem: function (e) {
          var t;
          e && Se("beforeChange", 0),
            (ne = C[1].el.children.length
              ? ((t = C[1].el.children[0]),
                m.hasClass(t, "pswp__zoom-wrap") ? t.style : null)
              : null),
            (te = f.currItem.bounds),
            (g = x = f.currItem.initialZoomLevel),
            (me.x = te.center.x),
            (me.y = te.center.y),
            e && Se("afterChange");
        },
          ...
          if (0 !== ge) {
            ...
            if (!(e && n < 2)) {
              (f.currItem = Xt(y)),
                (Ie = !1),
                Se("beforeChange", ge),
                3 <= n && ((s += ge + (0 < ge ? -3 : 3)), (n = 3));
              for (var i = 0; i < n; i++)
                0 < ge
                  ? ((t = C.shift()),
                    (C[2] = t),
                    Pe((++s + 2) * xe.x, t.el.style),
                    f.setContent(t, y - n + i + 1 + 1))
                  : ((t = C.pop()),
                    C.unshift(t),
                    Pe(--s * xe.x, t.el.style),
                    f.setContent(t, y + n - i - 1 - 1));
              !ne ||
                1 !== Math.abs(ge) ||
                ((e = Xt(D)).initialZoomLevel !== x &&
                  (en(e, fe), an(e), Re(e))),
                (ge = 0),
        ...
        updateSize: function (e) {
          if (!ve && h.modal) {
            var t = m.getScrollY();
            if (
              (z !== t && ((p.style.top = t + "px"), (z = t)),
              !e && be.x === window.innerWidth && be.y === window.innerHeight)
            )
              return;
            (be.x = window.innerWidth),
              (be.y = window.innerHeight),
              (p.style.height = be.y + "px");
          }
          if (
            ((fe.x = f.scrollWrap.clientWidth),
            (fe.y = f.scrollWrap.clientHeight),
            Xe(),
            (xe.x = fe.x + Math.round(fe.x * h.spacing)),
            (xe.y = fe.y),
            Ze(xe.x * he),
            Se("beforeResize"),
            s !== undefined)
            ...
            for (var n, i, o, a = 0; a < 3; a++)
              (n = C[a]),
                Pe((a + s) * xe.x, n.el.style),
                (o = y + a - 1),
                h.loop && 2 < Vt() && (o = De(o)),
                (i = Xt(o)) && (I || i.needsUpdate || !i.bounds)
                  ? (f.cleanSlide(i),
                    f.setContent(n, o),
                    1 === a && ((f.currItem = i), f.updateCurrZoomItem(!0)),
                    (i.needsUpdate = !1))
                  : -1 === n.index && 0 <= o && f.setContent(n, o),
                i && i.container && (en(i, fe), an(i), Re(i));
            I = !1;
          }
          (g = x = f.currItem.initialZoomLevel),
            (te = f.currItem.bounds) &&
              ((me.x = te.center.x), (me.y = te.center.y), ke(!0)),
            Se("resize");
        },
        zoomTo: function (t, e, n, i, o) {
          e &&
            ((g = x),
            (ft.x = Math.abs(e.x) - me.x),
            (ft.y = Math.abs(e.y) - me.y),
            Le(pe, me));
          var e = Ue(t, !1),
            a = {};
      ...
      bt = function (e, t) {
        return (
          ...
          (t(e) ? e : bt(e.parentNode, t))
        );
      },
      It = {},
      Ct = function (e, t) {
        return (
          (It.prevent = !bt(e.target, h.isClickableElement)),
          Se("preventDragEvent", e, t, It),
          It.prevent
        );
      },
      Dt = function (e, t) {
      ...
      kt = function (e) {
        ...
        return (
          O
            ...
            ? e.touches &&
              0 < e.touches.length &&
              ((Ot[0] = Dt(e.touches[0], At)),
              1 < e.touches.length && (Ot[1] = Dt(e.touches[1], Et)))
      ...
      Rt = function (e, t) {
        var n,
          ...
          a = me[e] + t[e] * u;
        if (
          (h.allowPanToNext || x === f.currItem.initialZoomLevel) &&
          (ne
            ? "h" !== oe ||
              "x" !== e ||
              K ||
              (r
                ? (a > te.min[e] &&
                    ...
                    (n = te.min[e] - pe[e])),
                  (n <= 0 || s < 0) && 1 < Vt()
                    ? ((o = l), s < 0 && l > lt.x && (o = lt.x))
                    : te.min.x !== te.max.x && (i = a))
                : (a < te.max[e] &&
                    ((u = h.panEndFriction),
                    te.max[e],
                    (n = pe[e] - te.max[e])),
                  (n <= 0 || 0 < s) && 1 < Vt()
                    ? ((o = l), 0 < s && l < lt.x && (o = lt.x))
                    : te.min.x !== te.max.x && (i = a)))
            : (o = l),
          "x" === e)
        )
          return (
            o !== undefined && (Ze(o, !0), (j = o !== lt.x)),
            te.min.x !== te.max.x &&
              (i !== undefined ? (me.x = i) : j || (me.x += t.x * u)),
            o !== undefined
          );
      ...
      Pt = function (e) {
        ...
        ("mousedown" === e.type && 0 < e.button) ||
          (Gt
            ? e.preventDefault()
            : (G && "mousedown" === e.type) ||
              (Ct(e, !0) && e.preventDefault(),
              Se("pointerDown"),
              O &&
                ((t = m.arraySearch(rt, e.pointerId, "id")) < 0 &&
                  (t = rt.length),
              ...
              !Q &&
                ...
                Le(nt, t[1]),
                Tt(tt, nt, ht),
                (ft.x = Math.abs(ht.x) - me.x),
                (ft.y = Math.abs(ht.y) - me.y),
                (ee = xt(tt, nt)))));
      },
      Zt = function (e) {
        var t, n;
        e.preventDefault(),
          !O ||
            (-1 < (t = m.arraySearch(rt, e.pointerId, "id")) &&
              (((n = rt[t]).x = e.pageX), (n.y = e.pageY))),
          X &&
            ((n = kt(e)),
            oe || q || Q
              ? (J = n)
              : mt.x !== xe.x * he
              ? (oe = "h")
              : ((e = Math.abs(n[0].x - ot.x) - Math.abs(n[0].y - ot.y)),
                Math.abs(e) >= et && ((oe = 0 < e ? "h" : "v"), (J = n))));
      },
      Ft = function () {
        if (J) {
          var e,
            ...
            if (
              ...
              (ot.x = tt.x),
                ...
                (!it.x && !it.y && yt(J[1], nt)) ||
                  ...
                  (i = Ye()),
                  a < n
                    ? h.pinchToClose && !se && g <= f.currItem.initialZoomLevel
                      ? (Ee((o = 1 - (n - a) / (n / 1.2))),
                        Se("onPinchClose", o),
                        (re = !0))
                      : (a = n - (t = 1 < (t = (n - a) / n) ? 1 : t) * (n / 3))
                    : i < a &&
                      (a = i + (t = 1 < (t = (a - i) / (6 * n)) ? 1 : t) * n),
                  t < 0 && (t = 0),
                  Tt(tt, nt, dt),
                  (de.x += dt.x - ht.x),
                  (de.y += dt.y - ht.y),
              ...
              (ae &&
                ((ae = !1),
                Math.abs(it.x) >= et && (it.x -= J[0].x - at.x),
                Math.abs(it.y) >= et && (it.y -= J[0].y - at.y)),
              (ot.x = tt.x),
              (ot.y = tt.y),
              0 !== it.x || 0 !== it.y)
            ) {
      ...
      Lt = function (e) {
        ...
        Se("pointerUp"),
          Ct(e, !1) && e.preventDefault(),
          !O ||
            (-1 < (n = m.arraySearch(rt, e.pointerId, "id")) &&
              ((a = rt.splice(n, 1)[0]),
        ...
        if (
          ...
          if ((je(), (Y = Y || zt()).calculateSwipeSpeed("x"), B))
            St() < h.verticalDragRange
              ? f.close()
              : ((i = me.y),
                (o = le),
                Je("verticalDrag", 0, 1, 300, m.easing.cubic.out, function (e) {
                  (me.y = (f.currItem.initialPosition.y - i) * e + i),
                    Ee((1 - o) * e + o),
                    ke();
                }),
                Se("onVerticalDrag", 1));
            ...
            ie ||
              ("swipe" === a ? !j && x > f.currItem.fitRatio && _t(Y) : Ht());
          }
      },
      zt = function () {
        var t,
          ...
          i = {
            ...
            calculateSwipeSpeed: function (e) {
              (n =
                1 < st.length
                  ? ((t = Ae() - H + 50), st[st.length - 2][e])
                  : ((t = Ae() - U), at[e])),
                (i.lastFlickOffset[e] = ot[e] - n),
            ...
            calculateOverBoundsAnimOffset: function (t, e) {
              i.backAnimStarted[t] ||
                (me[t] > te.min[t]
                  ? (i.backAnimDestination[t] = te.min[t])
                  : me[t] < te.max[t] && (i.backAnimDestination[t] = te.max[t]),
            ...
            panAnimLoop: function () {
              Ve.zoomPan &&
                ((Ve.zoomPan.raf = R(i.panAnimLoop)),
                (i.now = Ae()),
      ...
      Nt = function (e, t) {
        ...
        ie || (ct = y),
          "swipe" === e &&
            ...
            Qe < i && (e || 20 < t.lastFlickOffset.x)
              ? (a = -1)
              : i < -Qe && (e || t.lastFlickOffset.x < -20) && (a = 1)),
          a &&
            ((y += a) < 0
              ? ((y = h.loop ? Vt() - 1 : 0), (o = !0))
              : y >= Vt() && ((y = h.loop ? 0 : Vt() - 1), (o = !0)),
            (o && !h.loop) || ((ge += a), (he -= a), (n = !0)));
        var o = xe.x * he,
          a = Math.abs(o - mt.x),
          r =
            n || o > mt.x == 0 < t.lastFlickSpeed.x
              ? ((r =
        ...
        return (
          ...
          Je("mainScroll", mt.x, o, r, m.easing.cubic.out, Ze, function () {
            je(),
              (ie = !1),
              (ct = -1),
              (!n && ct === y) || f.updateCurrItem(),
      ...
      Kt = function (a, e, r, t) {
        ...
        Yt && clearTimeout(Yt),
          ...
          a.initialLayout
            ...
            : (l = h.getThumbBoundsFn && h.getThumbBoundsFn(y));
        ...
        if (!s || !l || l.x === undefined)
          return (
            Se("initialZoom" + (r ? "Out" : "In")),
            (x = a.initialZoomLevel),
            Le(me, a.initialPosition),
            ke(),
        ...
        (c = o),
          ...
          r ||
            ...
            ke()),
          $e("initialZoom"),
          r && !c && m.removeClass(p, "pswp--animated-in"),
          d &&
            (r
              ? m[(c ? "remove" : "add") + "Class"](p, "pswp--animate_opacity")
              : setTimeout(function () {
              ...
              Se("initialZoom" + (r ? "Out" : "In")),
                r
                  ? ((t = l.w / a.w),
                    ...
                    (e = function (e) {
                      1 === e
                        ? ((x = t), (me.x = l.x), (me.y = l.y - z))
                        : ((x = (t - i) * e + i),
                          (me.x = (l.x - n.x) * e + n.x),
                          (me.y = (l.y - z - n.y) * e + n.y)),
                        ke(),
                        d ? (p.style.opacity = 1 - e) : Ee(o - e * o);
                    }),
                    c
                      ? Je("initialZoom", 0, 1, s, m.easing.cubic.out, e, u)
                      : (e(1), (Yt = setTimeout(u, s + 20))))
                  : ((x = a.initialZoomLevel),
                    Le(me, a.initialPosition),
                    ke(),
                    Ee(1),
                    d ? (p.style.opacity = 1) : Ee(1),
                    (Yt = setTimeout(u, s + 20)));
            },
            r ? 25 : 90
          ));
      },
      ...
      on = function (e, t) {
        if (e.src && e.loadError && e.container)
          return (
            ...
            (e.container.innerHTML = h.errorMsg.replace("%url%", e.src)),
            !0
          );
      },
      an = function (e, t, n) {
        ...
        if ($t.length) {
          for (var e, t = 0; t < $t.length; t++)
            (e = $t[t]).holder.index === e.index &&
              tn(e.index, e.item, e.baseDiv, e.img, !1, e.clearPlaceholder);
          $t = [];
        }
      };
    Ce("Controller", {
      publicMethods: {
          ...
          m.extend(h, jt, !0),
            ...
            Me("initialLayout", function () {
              f.currItem.initialLayout =
                h.getThumbBoundsFn && h.getThumbBoundsFn(y);
            }),
            Me("mainScrollAnimComplete", rn),
            Me("initialZoomInEnd", rn),
            Me("destroy", function () {
        ...
        setContent: function (t, n) {
          ...
          a
            ? (Se("gettingData", n, a),
              (t.index = n),
              (o = (t.item = a).container = m.createEl("pswp__zoom-wrap")),
              !a.src &&
                a.html &&
                (a.html.tagName
                ...
                : ((a.loadComplete = function (e) {
                      ...
                      if (t && t.index === n) {
                        if (on(e, !0))
                          return (
                            ...
                            en(e, fe),
                            Re(e),
                            void (t.index === y && f.updateCurrZoomItem())
                          );
                        e.imageAppended
                          ? !Gt &&
                            e.placeholder &&
                  ...
                  f.allowProgressiveImg() &&
                    (!Bt && _.transform
                      ...
                      : tn(n, a, o, a.img, !0, !0))),
              Bt || n !== y ? Re(a) : ((ne = o.style), Kt(a, i || a.img)),
              (t.el.innerHTML = ""),
              t.el.appendChild(o))
            : (t.el.innerHTML = "");
        },
    ...
    Ce("Tap", {
      publicMethods: {
        initTap: function () {
          Me("firstTouchStart", f.onTapStart),
            Me("touchRelease", f.onTapRelease),
            Me("destroy", function () {
              (un = {}), (ln = null);
            });
        },
        ...
        onTapRelease: function (e, t) {
          ...
          t &&
            (q ||
              ...
              (i = n),
              (o = un),
              Math.abs(i.x - o.x) < a && Math.abs(i.y - o.y) < a)
                ? Se("doubleTap", n)
                : "mouse" !== t.type
        ...
        publicMethods: {
          ...
          setupDesktopZoom: function (e) {
            ...
            var n,
              i = function () {
                f.mouseZoomedIn &&
                  (m.removeClass(p, "pswp--zoomed-in"), (f.mouseZoomedIn = !1)),
                  x < 1
          ...
          handleMouseWheel: function (e) {
            if (x <= f.currItem.fitRatio)
              return (
                h.modal &&
                  (!h.closeOnScroll || Ke || X
                    ? e.preventDefault()
                    : E && 2 < Math.abs(e.deltaY) && ((o = !0), f.close())),
                !0
              );
            if ((e.stopPropagation(), (sn.x = 0), "deltaX" in e))
              1 === e.deltaMode
                ? ((sn.x = 18 * e.deltaX), (sn.y = 18 * e.deltaY))
                : ((sn.x = e.deltaX), (sn.y = e.deltaY));
            else if ("wheelDelta" in e)
              e.wheelDeltaX && (sn.x = -0.16 * e.wheelDeltaX),
                e.wheelDeltaY
                  ? (sn.y = -0.16 * e.wheelDeltaY)
                  : (sn.y = -0.16 * e.wheelDelta);
            else {
    ...
    var dn,
      ...
      Sn = function () {
        ...
        mn && clearTimeout(mn),
          Ke || X
            ? (mn = setTimeout(Sn, 500))
            : (fn ? clearTimeout(pn) : (fn = !0),
              (t = y + 1),
              (e = Xt(y)).hasOwnProperty("pid") && (t = e.pid),
              (e = xn + "&gid=" + h.galleryUID + "&pid=" + t),
              gn || (-1 === bn.hash.indexOf(e) && (wn = !0)),
              (t = bn.href.split("#")[0] + "#" + e),
              In
        ...
        initHistory: function () {
          ...
          m.extend(h, Cn, !0),
            h.history &&
              ...
              -1 < xn.indexOf("gid=") &&
                (xn = (xn = xn.split("&gid=")[0]).split("?gid=")[0]),
              Me("afterChange", f.updateURL),
              Me("unbindEvents", function () {
