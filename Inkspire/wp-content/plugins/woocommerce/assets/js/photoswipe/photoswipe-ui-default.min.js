            ...
            (function () {
              for (
                ...
                n = t.url
                  ...
                  .replace("{{image_url}}", encodeURIComponent(o))
                  .replace("{{raw_image_url}}", o)
    ...
    (_.init = function () {
      ...
      s.extend(o.options, E, !0),
        ...
        e("unbindEvents", function () {
          I || K(),
            b && clearInterval(b),
            s.unbind(document, "mouseout", z),
            s.unbind(document, "mousemove", y),
        ...
        w.timeToIdle &&
          e("mouseUsed", function () {
            s.bind(document, "mousemove", y),
              s.bind(document, "mouseout", z),
